...
INCLUDEPATH += $$BOOST_INCLUDE_PATH $$BDB_INCLUDE_PATH $$OPENSSL_INCLUDE_PATH $$QRENCODE_INCLUDE_PATH $$IXWEBSOCKET_INCLUDE_PATH
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,)  $$join(IXWEBSOCKET_LIB_PATH,,-L,) 
LIBS += -lssl -lcrypto -lixwebsocket -ldb_cxx$$BDB_LIB_SUFFIX
